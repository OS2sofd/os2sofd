...
public class OrgUnitManagerController {
	...
	public ResponseEntity<String> externalUpdate(@RequestBody List<ManagerService.OrgUnitManagerDto> orgUnitManagers) {
		managerService.importManagers(orgUnitManagers);
		return new ResponseEntity<>(HttpStatus.OK);
	}
