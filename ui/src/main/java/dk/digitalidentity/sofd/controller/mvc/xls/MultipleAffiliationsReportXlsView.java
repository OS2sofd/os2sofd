...
public class MultipleAffiliationsReportXlsView extends AbstractXlsView {
	...
	private void createHeader(Workbook workbook, Sheet sheet, ReportType reportType, ResourceBundleMessageSource messageSource, Locale locale) {
		...
		String header5 = messageSource.getMessage("xls.genericreport.affiliation.prime", null, locale);
		String header6 = messageSource.getMessage("xls.genericreport.affiliation.terms", null, locale);
		String header7 = messageSource.getMessage("xls.genericreport.affiliation.employeeId", null, locale);
		String header8 = messageSource.getMessage("xls.genericreport.user.id", null, locale);
