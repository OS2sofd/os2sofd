...
public enum EmailTemplateType {
	...
	AD_CREATE_MANAGER("html.enum.email.message.type.ad_create_manager", Arrays.asList(Flags.REQUIRE_ACCOUNT_CREATION, Flags.SHOW_CC, Flags.SEND_TO_MANAGER, Flags.SHOW_ORG_FILTER,Flags.SHOW_TO), Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.EMPLOYEE_PLACEHOLDER, EmailTemplatePlaceholder.ACCOUNT_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.POSITION_NAME_PLACEHOLDER)),
